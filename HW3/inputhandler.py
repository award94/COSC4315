...
#   Splits the list into dpn sized nodes
    def splitlistbydpn(self):
        ...
        #print("term1=",tempList1)
        #print("term2=",tempList2)

#   Does the math operation
    def domath(self):

        #print("term1=",self.listTerm1)
        #print("term2=",self.listTerm2)
        #print("DPN=",self.dpn)
        ...
        def addition(term1, term2, term3):
            ...
            def addrestofterm(term, term3, counter):
                if(counter >= 0):
                    ...
                    carryOver = int(term3[counter+1]/modShift)
