...
#   Does the math operation
    def domath(self):
        ...
        def addition(term1, term2):
            ...
            def baseaddition(term1, term2, term3):
                ...
                # term3 will be the result, I'm assigning nodes for the final sum, the sum  at max will be 1 node greater than the longer term
